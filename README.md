...
An interactive script to easily create questionnaires in **FiveM**, with **Discord webhook** integration to collect responses.

> Preconfigured by default for a **PPA application questionnaire** in **French**, but perfect for **any type of form**: job applications, sending CVs, RP surveys, internal tests, and more.
...
* 🔧 **Easy to Configure**
  ...
  * Questions, positions, and webhook can be adjusted easily.
...
* Players answer the questions, and the results are automatically sent to Discord.
